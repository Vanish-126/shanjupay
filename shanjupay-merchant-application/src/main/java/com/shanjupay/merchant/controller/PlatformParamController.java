...
public class PlatformParamController {
    ...
    /**
     * 接口15：查询平台支持的所有服务类型（controller层）
     * @return
     */
    ...
    /**
     * 接口17：为某个应用绑定服务类型（controller层）
     * 测试时，注意有从路径中获取变量，也有从请求里面获取参数
     * @param appId
